...
const MenuCard = ({ item, favoriteIds = [], onFavoriteToggle }) => {
  ...
  return (
    <div
      className={`group relative rounded-3xl bg-white shadow-[0_8px_30px_rgba(0,0,0,0.08)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.15)] border border-gray-100/50 transition-all duration-500 overflow-hidden flex flex-col ${
        isAvailable ? 'opacity-70' : 'hover:-translate-y-2 hover:scale-[1.02]'
      }`}
    >
      {/* Image container */}
