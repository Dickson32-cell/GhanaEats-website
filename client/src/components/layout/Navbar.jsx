          ...
          <div className="border-t border-gray-100 dark:border-white/10 py-4 space-y-1">
            ...
            <div className="pt-3 flex flex-col gap-2">
              {user ? (
                ...
                <>
                  <Link to="/login" className="block text-center rounded-2xl border border-gray-200 dark:border-white/20 py-2.5 text-sm font-semibold text-dark/70 dark:text-white/70 hover:bg-gray-50 dark:hover:bg-dark-700 transition-colors">{getSetting('signin_button_text')}</Link>
                  <Link to="/signup" className="block text-center rounded-2xl bg-dark dark:bg-white py-2.5 text-sm font-semibold text-white dark:text-dark">{getSetting('signup_button_text')}</Link>
                </>
              )}
            </div>
          </div>
